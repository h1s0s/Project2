...
public class ShopController {
	...
	public String shopListForm(Model model) {
		...
		return "/WEB-INF/view/shop/shopList.jsp";
	}
	//상품 카테고리 선택
	@ResponseBody
	...
	public String shopInfoForm(@RequestParam("itemNo") int itemNo,
		...
		return "/WEB-INF/view/shop/shopInfo.jsp";
	}
	//장바구니 추가
	@ResponseBody
	...
	public String payForm(@RequestParam ("itemNo") int itemNo,
		...
		return "/WEB-INF/view/shop/shopPay.jsp";
	}
	...
	public String myShopList(@RequestParam("usersNo") int usersNo,
		...
		return "/WEB-INF/view/shop/myShopList.jsp";
	}
	...
	public String myShopCart(Model model) {
		...
		return "/WEB-INF/view/shop/myShopCart.jsp";
	}
	...
	public String writeForm() {
		...
		return "/WEB-INF/view/shop/writeForm.jsp";
	}
	//판매자 - 상품 등록
	...
	public String modifyForm(@RequestParam("itemNo") int itemNo,
		...
		return "/WEB-INF/view/shop/modifyForm.jsp";
	}
	//판매자 - 상품 수정
	...
	public String shopAdmin(HttpSession session,
		...
		return "/WEB-INF/view/shop/shopAdmin.jsp";
	}
